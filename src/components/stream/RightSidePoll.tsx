...
export default function RightSidePoll() {
  ...
  useEffect(() => {
    ...
    container.innerHTML = "<a href='https://poll-maker.com/poll5660589xdb3e4E18-166' data-poll='5660597x585e9819-166' style='width:100%; display:block; text-align:right;'>.</a>";
